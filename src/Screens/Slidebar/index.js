...
import { AiOutlineBars, AiFillSchedule, AiOutlineOrderedList, AiFillPushpin, AiFillSetting, BiSupport } from 'react-icons/ai';
...
const Slidebar = (props) => {
    ...
    return (
        <>
            <button style={{ background: 'none', border: 'none', alignItems: 'center', justifyContent: 'center', display: 'flex', gap: 20 }} onClick={handleShow}>
            ...
            <Offcanvas show={show} onHide={handleClose}>
                <Offcanvas.Header closeButton>
                    <div style={{ display: 'flex', alignItems: "center", gap: 10 }}>
                        <img src={require('../../Images/logo.png')} style={{ width: 40, height: 40 }} />
                        <span style={{ fontSize: 24, fontWeight: 700 }}>Black Dollar</span>
                    </div>
                </Offcanvas.Header>
                <hr />
                <Offcanvas.Body style={{ display: "flex", justifyContent: 'space-between', flexDirection: 'column' }}>
                    <div>
                        ...
                        <Link to='/UploadVideo' style={{ textDecoration: 'none' }}>
                            <div style={{ marginBottom: 20 }}>
                                <button className='sliderButton' style={{ width: '100%', display: 'flex', alignItems: 'flex-start', alignItems: 'center', gap: 10, borderRadius: 5 }}> <AiFillSchedule id='sliderIcon' color='white' size={20} /><span style={{ fontSize: 20 }}>Scheduled New Video</span> </button>

                            </div>
                        </Link>
                        <Link to='/ScheduledVideoList' style={{ textDecoration: 'none' }}>
                            <div style={{ marginBottom: 20 }}>
                                <button className='sliderButton' style={{ width: '100%', display: 'flex', alignItems: 'flex-start', alignItems: 'center', gap: 10, borderRadius: 5 }}> <AiOutlineOrderedList id='sliderIcon' color='white' size={20} /><span style={{ fontSize: 20 }}>Scheduled Video List</span> </button>
